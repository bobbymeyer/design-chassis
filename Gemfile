...
gem "pandatone", github: "bobbymeyer/pandatone", branch: "swiss-1"
gem "stripeclub", github: "bobbymeyer/stripeclub", branch: "swiss-1"
...
git "https://github.com/bobbymeyer/badger", branch: "swiss-1" do
  gem "badger"
  gem "badger-rails"
end
